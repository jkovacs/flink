...
/**
 * The abstract outer join driver implements the logic of an outer join operator at runtime. It instantiates a
 * sort-merge based strategy to find joining pairs of records or joining records with null depending
...
public abstract class AbstractOuterJoinDriver<IT1, IT2, OT> implements PactDriver<FlatJoinFunction<IT1, IT2, OT>, OT> {
	...
	public void prepare() throws Exception{
		...
		if (objectReuseEnabled) {
			setReusingOuterJoinIterator(ls, in1, in2, serializer1, comparator1, serializer2, comparator2, pairComparatorFactory,
					memoryManager, ioManager, numPages);
		} else {
			setNonReusingOuterJoinIterator(ls, in1, in2, serializer1, comparator1, serializer2, comparator2, pairComparatorFactory,
					memoryManager, ioManager, numPages);
		}
	...
	protected abstract void setReusingOuterJoinIterator(DriverStrategy driverStrategy, MutableObjectIterator<IT1> in1,
														...
														TypeComparator<IT2> comparator2, TypePairComparatorFactory<IT1, IT2> pairComparatorFactory,
														MemoryManager memoryManager, IOManager ioManager, int numPages) throws Exception;

	protected abstract void setNonReusingOuterJoinIterator(DriverStrategy driverStrategy, MutableObjectIterator<IT1> in1,
														MutableObjectIterator<IT2> in2, TypeSerializer<IT1> serializer1,
														TypeComparator<IT1> comparator1, TypeSerializer<IT2> serializer2,
														TypeComparator<IT2> comparator2, TypePairComparatorFactory<IT1, IT2> pairComparatorFactory,
														MemoryManager memoryManager, IOManager ioManager, int numPages) throws Exception;
