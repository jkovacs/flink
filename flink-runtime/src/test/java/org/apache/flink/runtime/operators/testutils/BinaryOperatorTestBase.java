...
public class BinaryOperatorTestBase<S extends Function, IN, OUT> implements PactTaskContext<S, OUT> {
	...
	public void addInputSorted(MutableObjectIterator<IN> input, TypeSerializer<IN> serializer,
